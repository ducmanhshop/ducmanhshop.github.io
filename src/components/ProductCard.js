    ...
    <div className="group bg-white rounded-[24px] md:rounded-[32px] p-3 md:p-4 shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-black/5 flex flex-col product-card-hover transition-all duration-300 relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col px-1">
        ...
        <div className="flex gap-2">
          ...
          <Link href={`/product/${p.id}`} onClick={() => trackAction('click')} className="flex-1 bg-[#1d1d1f] text-white h-11 md:h-12 rounded-[14px] md:rounded-[16px] font-bold text-[12px] md:text-[13px] hover:bg-black/80 hover:scale-[0.98] transition-all flex items-center justify-center gap-1.5 btn-press shadow-md">
